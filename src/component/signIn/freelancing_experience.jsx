...
function Freelancing_Experience({ modalData, setModalData }) {
    ...
    const emp_data = [
        { amount: 'I am just getting started', image: just_me },
        { amount: 'Freelancing online', image: two_ten },
        { amount: 'Freelancing online', image: eleven_sixty },
        { amount: 'Both online and offline', image: fifty_one_five_hundred }]
    return (
        <div className="h-full px-10 w-full mt-5 flex items-center justify-center flex-col gap-3">
            <h2 className="text-center font-bold text-gray-800 md:text-2xl md:font-semibold text-lg sm:text-2xl">
                What’s your freelancing experience?
            </h2>
            <p className="text-center text-[#656565] text-sm">Whatever your style, we’ll make it work.</p>
                    ...
                    >
                        ...
                        <div className="flex sm:flex-col">
                            <img
                                ...
                                src={item.image}
                            />
                            <h1 className=" w-40 text-base sm:text-lg font-medium">{item.amount}</h1>
...
export default Freelancing_Experience